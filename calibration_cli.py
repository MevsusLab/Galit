...
from galit.calibration import (ParameterSet, audit_csv, calibrate_physical, calibrate_risk_policy,
 evaluate_parameter_set, generate_template, load_history, split_by_well,
 temporal_group_holdout, write_audit_markdown, write_report)
...
def main(argv=None)->int:
 ...
 if a.command=="calibrate":
  ...
  ps.save(a.output);print(a.output);return 0
